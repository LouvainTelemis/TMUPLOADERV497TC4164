...
${MyHostname}    demo6733
${MyRepositoryName}    TMUPLOADERV497TC4164
...
Test08
    [Documentation]    Check that the text area [Comment] and the list of user groups [Recipients] both exist on the page
    [Tags]    CRITICALITY NORMAL
...
Test18
    ...
    Run Keyword If    ${NbrOfFilesInDirData} > 0    Log    Image files have been imported successfully to dir externalBundles
